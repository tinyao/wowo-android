    ...
    private void login(String email, String password) {
        User.logInInBackground(email, password, new LogInCallback() {
            public void done(AVUser user, AVException e) {
                ...
                if (user != null) {
//                    fetchAmaLikes();
                    Intent postsIntent = new Intent(LoginActivity.this, MainActivity.class);
...
//    private void fetchAmaLikes() {
//        WowoApi.likedAmas(new FindCallback<Ama>() {
//            @Override
//            public void done(List<Ama> amas, AVException e) {
//                SharedPreferences sp = getApplicationContext().getSharedPreferences("likes", MODE_PRIVATE);
//                String objectIds = "";
//                for (Ama item:amas) {
//                    objectIds +=  ("|" + item.getObjectId());
//                }
//                sp.edit().putString("ObjectIds", objectIds).commit();
//                WoApplication.likedAmaIds = objectIds;
//            }
//        });
//    }
