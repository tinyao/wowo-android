...
public abstract class FadingActionBarHelperBase {
    ...
    private boolean isTopGradient = true;
    ...
    public final <T extends FadingActionBarHelperBase> T gradient(boolean topGradient) {
        isTopGradient = topGradient;
        return (T)this;
    }
    ...
    public final View createView(LayoutInflater inflater) {
        ...
        if (mHeaderOverlayView != null) {
            ...
            mMarginView.addView(mHeaderOverlayView, params);
        }
